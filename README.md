...
## Neural Networks, Data processing, Useful Tools

* [Waste Sorting using Neural Networks](https://is.muni.cz/th/422433/fi_b/bachelor-thesis__16_.pdf)

* [Bachelor Thesis code mainly in TensorFlow for image recognition of waste](https://github.com/jodik/Bachelor-thesis)

* [fast BASH downloader for multiple images sourced via 'Google Images'](https://github.com/teracow/googliser)

* [prepare the image data set for machine learning](https://github.com/icoxfog417/mlimages)
...
* [Как превратить сбор мусора в городскую игру](http://www.the-village.ru/village/city/city/167497-kak-zastavit-gorozhan-sobirat-musor)

* [Racoon](https://techcrunch.com/video/racoon/57d5ce4d1c68992475f75cbe/)

* [Вывоз и утилизация отходов в Москве, ЦФО, СЗФО, Санкт-Петербурге](https://util.bz/)
...
## Non-profit ecological projects

* [База данных штрихкодов](https://systemeco.ru/view-barcodes)

* [Карта пунктов приема вторсырья](https://vk.com/ecopoint)
